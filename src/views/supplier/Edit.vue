<template>
  <el-breadcrumb separator-class="el-icon-arrow-right">
    ...
    <el-breadcrumb-item separator-class="el-icon-arrow-right">Supplier Edit</el-breadcrumb-item>
    <el-breadcrumb-item>Supplier Edit</el-breadcrumb-item>
  </el-breadcrumb>
  <el-form
    ...
    class="form-body"
  >
    <h1 :span="3" class="user-title">Edit Supplier</h1>
    <el-row :span="16">
...
export default {
  ...
  mounted() {
    this.form = this.supplier.supplier;
  },
  methods: {
    ...mapActions("supplier", ["updateSupplier", "getSupplier"]),
    Back() {
