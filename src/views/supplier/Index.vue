<template>
  ...
  <el-tabs type="card" @tab-click="handleClick">
    <el-tab-pane label="Suppliers">
      <el-row>
        <el-col :span="14">
          <p class="pagi-info" v-if="supplier.suppliers">
            Total {{ supplier.suppliers.meta.total }} items, current page
            {{ supplier.suppliers.meta.current_page }}
          </p>
        </el-col>
        <el-col :span="10">
      ...
      <supplier-list
        :data="supplier.suppliers.data"
        v-if="supplier.suppliers"
      ...
      <el-pagination
        ...
        v-if="supplier.suppliers"
        :total="supplier.suppliers.meta.total"
